...
{
       0,    41,    41,    41,    42,    42,    45,    46,    49,    63,
      65,    69,    71,    80,    84,    86,    88,    90,    92,    94,
      98,   105,   113,   124,   125
};
#endif
...
static const char *const yytname[] =
{
  ...
  "tINT", "tBOOL", "ID", "TOKEN_OR", "TOKEN_AND", "TOKEN_RETURN", "'+'",
  "'*'", "'='", "';'", "'('", "')'", "$accept", "prog", "$@1", "$@2",
  "lDeclarations", "Declaration", "lSentences", "Sentence", "E", "V",
  "Type", YY_NULLPTR
};
